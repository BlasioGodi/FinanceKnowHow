...
const OffCanvas = {
    ...
    collapseArchives: document.getElementById("collapseArchives"),
    collapseInvestments: document.getElementById("collapseInvestments"),
...
function toggleOffcanvas() {  
    ...
    OffCanvas.collapseArchives.classList.remove('show');
    OffCanvas.collapseInvestments.classList.remove('show');
